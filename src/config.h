...
// Adapted for BOARD_ESP32_WROOM_OLED: replaces TFT_eSPI/SD/PCF8574/XPT2046
// with shims that drive an SSD1306 OLED + LittleFS + GPIO buttons.

/* ───────────── Common includes ───────────── */
#include <Arduino.h>
#include "DisplayAdapter.h"   /* replaces <TFT_eSPI.h> */
#include "PCF8574Adapter.h"   /* replaces <PCF8574.h> */
#include "XPT2046Adapter.h"   /* replaces <XPT2046_Touchscreen.h> */
#include <SPI.h>
#include <Wire.h>
#include <EEPROM.h>
